...
최종 갱신: 2026-08-30
현재 단계: 사진 배달·테스트 UI 제거·창 오르기 설정 조정 완료, Windows 수동 검증
전체 상태: 요청 범위 구현과 프런트·Rust 자동 검증 완료, 실제 앱에서 크기·속도·설정 전환·자동 하강 육안 확인 필요
...
- 작업: 실제 Windows 앱에서 사진 배달과 창 오르기 설정 수동 검증
- 시작 시각: 2026-08-30
- 목표 종료: 일반 사진 크기·희귀 사진 85% 크기·6초 이동, 테스트 버튼 비노출, 창 오르기 ON/OFF와 8~15초 자동 하강 확인 시
